...
public class CameraView extends SurfaceView implements Camera.PreviewCallback, SurfaceHolder.Callback {
	...
	private String mFlashMode = Parameters.FLASH_MODE_ON;
	private int mOpenCamera = CameraInfo.CAMERA_FACING_BACK;
	...
	public void zoomout() {
		...
		Parameters localParameters = mCamera.getParameters();
	...
	public void startVideoRecording() {
		...
		int mCurrentIndex = AppPreference.getInt(AppPreference.KEY.CAMERA_RESOLUTION_INDEX, 0);
		...
		try {
			...
			mRecorder.setOutputFile(ResourceUtil.getCaptureVideoFilePath(XtremeBucketListApp.getContext()));
			mRecorder.prepare();
			mRecorder.start();
